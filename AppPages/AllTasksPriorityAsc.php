...
<body>
    <header>
        ...
        <div>
            ...
            <a style="margin-left: 20px;" href="logout.php"><svg xmlns="http://www.w3.org/2000/svg" width="45"
                    height="46" viewBox="0 0 45 46" fill="none">
    ...
    <div class="boxedDiv">
        <div class="space-evenly-items">
            ...
            <div class="dropdown">
                <button class="dropbtn"> <svg style="padding-top: 5px" width="23" height="14" viewBox="0 0 23 14"
                        fill="none">
                        <path
    ...
    <table>
        ...
        $sql = "SELECT TaskID, TaskTitle, DueDate, Priority, Status, CategoryID, TaskDescription FROM task WHERE Email = ? ORDER BY 
    CASE 
        WHEN Priority = 'low' THEN 1
        WHEN Priority = 'medium' THEN 2
        WHEN Priority = 'high' THEN 3
            ...
            <div class="TaskContainer">
                <form id="updatetask" action="updateTask.php" method="post">
                    ...
                    <div class="form-row1">
                        ...
                        <div class="priority">
                            <label for="update-task-priority"><img src="../media/priorityIcon.svg"
                                    alt="Priority"></label>
                    ...
                    <div class="form-row2">
                        <div class="category">
                            <label for="update-task-category"><img src="../media/categoryIcon.svg"
                                    alt="Category"></label>
